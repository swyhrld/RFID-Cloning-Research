...
```bash
hf icl chk -f iclass_elite_keys.dic --elite ![chk](./images/chk.png)
hf iclass calcnewkey --oki 4 --nki 1 --oldelite ![calc](./images/calc.png)
hf iclass wrbl --blk 3 -d D7DACAD37ACA9DED --ki 4 --elite ![wrbl](./images/wrbl.png)
```
